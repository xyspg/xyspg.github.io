...
function App() {
    ...
    const [texts2, setTexts2] = useState(["黄九歌对你一直具有攻击性","你只有00:01这一分钟可以勃起","你身边会充满魔怔键政人","你会无法离开北大附中","你会立刻变得符合你仇人的XP","你会变成其他人的星怒","你会被雌小鬼反杀","你会被原批们追杀","永远无人与你打电动","每过一分钟身边就会出现一只随机节肢动物","你喜欢的游戏会立刻被ylg入侵","牛子立即消失","包西餐会立即对你发起文言攻击","每天必须使用100次超能力","永远无法登录游戏平台","你无法停止打胶"]);
    ...
    const [textsSet, setTextsSet] = useState(texts1);
