...
function App() {
    const [texts1, setTexts1] = useState (["永远不会打胶而死","可以随时随地传送到北大附中","可以立刻让群友破防","可以反杀所有的雌小鬼","可以随时让一个群友传送到你身边","永远有人想和你打游戏","永远不会遇到键政魔怔人","可以让同学院的一个人变成你的星怒","每过一个学期就会增加一个完美的展","立即清除群里所有的原批","可以改变附近十米内所有生物的牛子大小","让你的仇人变成符合你XP的性奴","随时入眠","可以通过网线前往群友家","找不到图源时立刻有hero降临","变成扶她","自由控制聊天对象的性别","习得古神语","随时开出任何人的塔照","绝对不会被开盒","可以＠所有人"]);
